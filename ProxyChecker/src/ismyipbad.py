...
# https://gist.github.com/dicksonkv/77b153cd32dda3a2ec0532e742c45625
# Loading dns module.

# https://github.com/andreasf/check-dnsbl/blob/master/check-dnsbl.py
def IsMyIpBad(searchIp):
    try:
        import dns.resolver
